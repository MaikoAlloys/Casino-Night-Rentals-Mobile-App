...
const EventManagerFeedback = () => {
  ...
  const fetchFeedback = async () => {
    try {
      ...
      const response = await api.get('/eventmanager/feedback');
  ...
  const handleReplySubmit = async (feedbackId) => {
    ...
    try {
      ...
      const response = await api.post('/eventmanager/reply', {
        feedbackId,
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subHeader}>Review and respond to event feedback</Text>
...
export default EventManagerFeedback;