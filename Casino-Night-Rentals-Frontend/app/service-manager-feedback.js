...
const ServiceManagerFeedback = () => {
  ...
  const fetchFeedback = async () => {
    try {
      ...
      const response = await api.get('/servicemanager/feedback');
  ...
  const handleReplySubmit = async (feedbackId) => {
    ...
    try {
      ...
      const response = await api.post('/servicemanager/feedback/reply', {
        feedbackId,
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subHeader}>Review and respond to service feedback</Text>
...
// Reuse the same styles from finance-feedback.js
...
export default ServiceManagerFeedback;